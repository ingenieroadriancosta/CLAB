BOOL               CHannSave[4];
////////////////////////////////////////////////////////////////////////////////
BOOL CALLBACK SaveDLG( HWND hDlg, UINT  message, WPARAM wParam, LPARAM lParam ){
...
WHEN( WM_COMMAND )
    ...
    ELSIF LOWORD(wParam)==140 THEN
       ...
       FOR int i=0; i<4; i++ LOOP
           CHannSave[i] = SendMessage( GetDlgItem( hDlg, 128 + i ), BM_GETCHECK, 0, 0 )==BST_CHECKED;
       ENDLOOP;
...
WHEN( WM_INITDIALOG )
    FOR int i=0; i<4; i++ LOOP
        SendMessage( GetDlgItem( hDlg, 128 + i ), BM_SETCHECK, (WPARAM)(CHannSave[i]), 0 );
    ENDLOOP;
...
// perame un momento, voy al trono

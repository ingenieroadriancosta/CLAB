...
const int LenVARNAME = 20;
char CHexFile[256] = { -44, -63, -60, -33, -59, -45, -47, -43, -59, -51, -63, -44, -55, -61, -49, -82, -28, -17, -29, -8 };
...
IF SaveFileAs( CHexFile, HWFath, 4 )==0 THEN
    return FALSE;
ENDIF;
...
HRSRC hResource = FindResourceA( INSTANCIA_GLOBAL, MAKEINTRESOURCE(ID_FILES_ALL), MAKEINTRESOURCE(ID_FILES_SCHTAD) );
